...
#pragma warning restore 0649
        ...
        {
            UnityWebRequest uwr = UnityWebRequest.Get($"{Instance.RestDocumentBasePath}{path}");
        ...
        private UnityWebRequest BuildPost(string path, (string, string)[] queryParameters, byte[] postData)
        {
            ...
            UnityWebRequest uwr = UnityWebRequest.Post($"{Instance.RestDocumentBasePath}{path}{queryUrlBuilder.ToString()}", "");
        ...
        {
            UnityWebRequest uwr = UnityWebRequest.Put($"{Instance.RestDocumentBasePath}{path}", bodyData);
            return await SetupAndSendUWRAsync(uwr);
        }
        ...
        internal async Task<UnityWebRequest> UWRDelete(string path)
        {
            ...
            UnityWebRequest uwr = UnityWebRequest.Delete($"{Instance.RestDocumentBasePath}{path}");
            return await SetupAndSendUWRAsync(uwr);
        }
